<?php require("users/php/connect_to_db.php");
require("users/php/connect_to_products.php") ?>
<!DOCTYPE html>
<html lang="en">
...
<head>
    ...
    <link rel="shortcut icon" href="users/img/favicon.png" type="image/png">
    <link rel="stylesheet" href="users/css/slick.css">
    <link rel="stylesheet" href="userscss/slick-theme.css">
...
<body>
    ...
    <script src="users/js/bootstrap.js"></script>
    <script src="users/js/owl.carousel.min.js"></script>
    <script src="users/js/slick.js"></script>
    <script src="users/js/countdown.js"></script>
