...
<body>
    ...
    <div class="wrappage">
        <header id="header" class="header-v5">
          ...
          <!-- topbar-->
          <?php include("php/topbar_unsigned.php"); ?>
            <!-- end of topbar -->
                            ...
                            <form class="login-form" method="post" action="#"> 
                                  <div class="form-group">
                                    <label>Email address <span class="f-red">*</span></label>
                                      <input type="email" id="author2" class="form-control bdr" name="email" value="" required>
                                      <label>Username<span class="f-red">*</span></label>
                                      <input type="text" id="author2" class="form-control bdr" name="username" value="" required>
                                      <label>Password <span class="f-red">*</span></label>
                                      <input type="password" id="email2" class="form-control bdr" name="password" value="" required>
                                  </div>
                                  <div class="flex lr">
                                      <input type="submit" name="register" value="Register" class="btn btn-submit btn-gradient">
