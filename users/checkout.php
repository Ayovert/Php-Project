                        ...
                        <div class="checkout-login col-xs-12 col-sm-6">
                            ...
                            <form method="post" class="myaccount form-customer form-login js-openlogin">
                                ...
                                <div class="form-group ">
                                    ...
                                    <input type="email" class="form-control form-account form-account" 
                                    id="exampleInputEmail1">
                                </div>
                                <div class="form-group ">
                                    <label for="exampleInputPassword1">Password *</label>
                                    <input type="password" class="form-control form-account form-account" 
                                ...
                                <div class="co-left bd-7">
                                    ...
                                    <div class="row form-customer">
                                        <div class="form-group col-md-6">
                                            ...
                                            <input type="text" id="inputfname_2" name="FirstName" value="<?php echo $row['FirstName']; ?>" class="form-control form-account">
                                        </div>
                                        <div class="form-group col-md-6">
                                            <label for="inputlname" class=" control-label">Last Name <span class="f-red">*</span></label>
                                            <input type="text" id="inputlname" name="LastName" value="<?php echo $row['LastName']; ?>" class="form-control form-account">
                                        </div>
                                        <div class="form-group col-md-12">
                                            <label for="inputcompany" class=" control-label">Company Name</label>
                                            <input type="text" id="inputcompany" name="CompanyName" value="<?php echo $row['CompanyName']; ?>" class="form-control form-account">
                                        </div>
                                        <div class="form-group col-md-12">
                                            <label for="inputcountry1" class=" control-label">Country <span class="f-red">*</span></label>
                                            
                                            <input type="text" id="inputcountry1" name="Country" value="<?php echo $row['Country']; ?>" class="form-control form-account">
                                        </div>                                    
                                        <div class="form-group col-md-12">
                                            <label for="inputstreet" class=" control-label">Street address <span class="f-red">*</span></label>
                                            <input type="text" id="inputstreet" name="StreetAddress" value="<?php echo $row['StreetAddress']; ?>" class="form-control form-account">
                                        </div>
                                        <div class="form-group col-md-12">
                                            <label for="inputpostcode" class=" control-label">Postcode / ZIP</label>
                                            <input type="text" id="inputpostcode" name="PostCode" value="<?php echo $row['PostCode']; ?>" class="form-control form-account">
                                        </div>
                                        <div class="form-group col-md-12">
                                            <label for="inputfState" class=" control-label">Town / City <span class="f-red">*</span></label>
                                            <input type="text" id="inputfState" name="TownCity" value="<?php echo $row['TownCity']; ?>" class="form-control form-account">
                                        </div>
                                        <div class="form-group col-md-6">
                                            <label for="inputphone" class=" control-label">Phone <span class="f-red">*</span></label>
                                            <input type="text" id="inputphone" name="Phone" value="<?php echo $row['Phone']; ?>" class="form-control form-account">
                                        </div>
                                        <div class="form-group col-md-6">
                                            <label for="inputemail" class=" control-label">Email Address <span class="f-red">*</span></label>
                                            <input type="text" id="inputemail" name="email" value="<?php echo $row['email']; ?>" class="form-control form-account">
                                        </div>
